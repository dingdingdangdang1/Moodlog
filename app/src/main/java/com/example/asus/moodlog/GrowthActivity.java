...
public class GrowthActivity extends AppCompatActivity implements  Runnable {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView noda2=findViewById(R.id.nodata22);
        listView=findViewById(R.id.soup_list2);
        ...
        handler = new Handler(){
            ...
            public void handleMessage(Message msg) {
                if(msg.what == msgWhat){
                    ...
                    listItemAdapter = new SimpleAdapter(GrowthActivity.this, soupList, // listItems数据源
