...
public class YaoMoodActivity extends AppCompatActivity {
    ...
    private static String str[]={"笑一笑十年少","好气！","让悲伤逆流成河","思考是进步的重要途径","加油吧少年"};
    private static int pics[]={R.mipmap.smile,R.mipmap.angry,R.mipmap.ku,R.mipmap.thinking,R.mipmap.smiledai};
        ...
        public void handleMessage(Message msg){
            ...
            switch (msg.what){
                case 10:
                    ...
                    int num=Math.abs(r.nextInt())%5;//生成整数0-4的随机数
